...
__NetID__ = "cryerp"
__GitHubID__ = "cryerp"
__SelfGrade__ = "maximum credit possible plus some"
__Challenge__ = "1"
__Answer1__ = "the most probable sum of eight trials becomes more biased toward 8, so as you increase" \
              "the probabilty of flipping heads more heads start to appear!" \
              "the sum of the values in Distribution is 1"
__Answer2__ = " 6 "
...
print("The sum of the values in distribution is %.2f" % DistSum)
